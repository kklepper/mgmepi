...
-define(CFG_DB_CHECKPOINT_SPEED_SR,                   165). % deprecated
...
-define(NDB_MGM_EVENT_CATEGORY_STARTUP,      ?CFG_LOGLEVEL_STARTUP).
-define(NDB_MGM_EVENT_CATEGORY_SHUTDOWN,     ?CFG_LOGLEVEL_SHUTDOWN).
-define(NDB_MGM_EVENT_CATEGORY_STATISTIC,    ?CFG_LOGLEVEL_STATISTICS).
-define(NDB_MGM_EVENT_CATEGORY_CHECKPOINT,   ?CFG_LOGLEVEL_CHECKPOINT).
-define(NDB_MGM_EVENT_CATEGORY_NODE_RESTART, ?CFG_LOGLEVEL_NODERESTART).
-define(NDB_MGM_EVENT_CATEGORY_CONNECTION,   ?CFG_LOGLEVEL_CONNECTION).
-define(NDB_MGM_EVENT_CATEGORY_BACKUP,       ?CFG_LOGLEVEL_BACKUP).
